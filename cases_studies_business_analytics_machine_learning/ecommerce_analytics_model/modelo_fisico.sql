-- Estudo de Caso 1 - Construindo e Implementando Modelo de Dados Para o Portal de E-commerce
-- Modelo Físico

--Cria o schema no banco de dados
CREATE SCHEMA dw AUTHORIZATION ecommerce_analytics_admin;
...
-- Criação da Tabela Fatos Vendas
