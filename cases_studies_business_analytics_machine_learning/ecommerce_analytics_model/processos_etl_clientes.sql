...
DECLARE
	...
	cidades VARCHAR[] := ARRAY['São Paulo, Brasil', 'Rio de Janeiro, Brasil', 'New York, EUA', 'Los Angeles, EUA', 'Chicago, EUA'];
BEGIN
	WHILE i <= num_clientes LOOP
		nome_cliente := 'Cliente Konoha' || i::TEXT;
...
-- Visualiza os dados
SELECT * FROM dw.Clientes ORDER BY clienteid ASC
