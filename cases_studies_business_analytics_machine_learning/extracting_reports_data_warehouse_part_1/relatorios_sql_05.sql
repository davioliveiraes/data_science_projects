...
VALUES ('Harvey Specter', '5th Avenue', 'Nova York', 'EUA');
...
-- Atualiza o cliente
UPDATE dw.Cliente
SET Endereco = 'Broadway, 99999', CidadeCliente = 'Nova York', PaisCliente = 'EUA'
WHERE ClienteID = 108;

-- Visualizar a tabela e auditoria
SELECT * FROM dw.tb_auditoria_cliente
ORDER BY auditoria_id ASC

-- Delete
DELETE FROM dw.Cliente WHERE ClienteID = 108;

-- Visualizar a tabele e auditoria
SELECT * FROM dw.tb_auditoria_cliente
ORDER BY auditoria_id ASC
